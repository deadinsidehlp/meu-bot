...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/deadinsidehlp/meu-bot/master/langIndex.json", function (json) {
            ...
            helpCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.starterhelp, {link: 'https://raw.githubusercontent.com/deadinsidehlp/meu-bot/master/Ajuda link' }));
                    }
                }
            },
